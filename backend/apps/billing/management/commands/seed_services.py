...
SERVICES = [
    ...
    ("PHA-IBU", "Ibuprofen 400mg (per tablet)", Department.PHARMACY, "15.00"),
    ("PHA-METRO", "Metronidazole 400mg (per tablet)", Department.PHARMACY, "15.00"),
    ("PHA-CTX", "Ceftriaxone 1g injection (per vial)", Department.PHARMACY, "350.00"),
